...
public class CloudantClient 
{
	...
	public CloudantClient()
	{
		...
		this.port = 443;
		this.host = "dc17aca6-6036-4720-ade7-23f6a4dbc4c3-bluemix.cloudant.com";
		this.username = "dc17aca6-6036-4720-ade7-23f6a4dbc4c3-bluemix";
		this.password="de66c4e3400b6fa94dfd9655e2723d5b4671ed08d402a35425c0ecf2e0c57fde";
		this.name = "cloudantNoSQLDB";
		this.dbc = this.createDBConnector();
