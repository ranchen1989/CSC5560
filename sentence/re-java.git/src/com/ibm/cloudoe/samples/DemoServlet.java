...
public class DemoServlet extends HttpServlet {
	...
	private String baseURL = "https://gateway.watsonplatform.net/relationship-extraction-beta/api";
	private String username = "aafd7677-15cd-43d4-be48-db50653d6f94";
	private String password = "9y6cy9h8WLIo";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    	...
    	try {
    		Executor executor = Executor.newInstance().auth("aafd7677-15cd-43d4-be48-db50653d6f94", "9y6cy9h8WLIo");
